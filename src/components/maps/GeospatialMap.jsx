  ...
  return (
    <div className="panel map-panel">
      <div className="panel-heading compact">
        <div>
          <h3>Telemetry Map</h3>
          <p>Reference fleet positions and geofence overlays.</p>
        </div>
      ...
      <div className="map-canvas geospatial-fallback" aria-label="Drone location map">
        ...
        <div className="map-label">Fleet map preview</div>
      </div>
      <div className="map-legend">
        <span><i className="dot green" /> Reference drone</span>
        ...
        <span className="map-legend-detail">{activeFlightPath.length} reference path points loaded</span>
      </div>
    </div>
  );
};
