        ...
        <div className="modal-body">
          ...
          <div className="profile-grid">
            <ProfileSection icon={FileText} title="Report Summary">
              ...
              <ProfileRow label="Generated By" value={report.generatedBy ?? report.owner} />
              <ProfileRow label="Generated At" value={formatDateTime(report.generatedAt ?? report.createdAt)} />
            </ProfileSection>
            ...
            <ProfileSection icon={BarChart3} title="Snapshot Values">
              ...
              <ProfileRow label="Generated At" value={formatDateTime(report.generatedAt ?? report.createdAt)} />
              <ProfileRow label="Reporting Period" value={report.reportingPeriod ?? formatScopeRange(report.dataSnapshot?.scope)} />
